...
public class MainActivity extends AppCompatActivity {
    ...
    private String input, output, newOutput, newinput;
    private Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonAdd, buttonMultiply, buttonSubs, buttonDivision, buttonPoint, buttonPercent, buttonPower, buttonEqual, buttonClear, buttonDel;
